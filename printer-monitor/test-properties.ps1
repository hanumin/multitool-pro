...
Write-Host ""
Write-Host "Actual schema for Event ID 307 (Windows 10/11):"
Write-Host "  Properties[0] = Document ID / Job ID"
Write-Host "  Properties[1] = Document Name"
Write-Host "  Properties[2] = User Name"
Write-Host "  Properties[3] = Computer Name (not printer!)"
Write-Host "  Properties[4] = Printer Name ← FILTER BY THIS"
Write-Host "  Properties[5] = Port (USB002, LPT1, etc.)"
Write-Host "  Properties[6] = Size in bytes"
Write-Host "  Properties[7] = TotalPages ← PAGES PRINTED"
Write-Host ""
